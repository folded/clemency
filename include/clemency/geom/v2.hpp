...
struct v2_t {
  ...
  static v2_t zero() { return v2_t::init(num_t(0), num_t(0)); }
  ...
  v2_t abs() const { return v2_t::init(std::abs(x), std::abs(y)); }

  v2_t scale(num_t s) const { return init(x * s, y * s); }
  ...
  static v2_t neg(const v2_t& a) { return init(-a.x, -a.y); }
  ...
  static bool neq(const v2_t& a, const v2_t& b) { return !eq(a, b); }
  ...
  static v2_t cmul(const v2_t& a, const v2_t& b) {
    return init(a.x * b.x - a.y * b.y, a.x * b.y + a.y * b.x);
  }

  static v2_t cdiv(const v2_t& a, const v2_t& b) { return cmul(a, cinv(b)); }
